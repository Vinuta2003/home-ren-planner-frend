...
//   return (
//     <div className="min-h-screen bg-[#F3F9FF] p-8">
...
//               </h3>
//               <p className="text-gray-500 mb-3">{phaseType.replaceAll("_", " ")}</p>
...
//                   className="mt-6 bg-blue-100 text-blue-700 font-medium px-4 py-2 rounded hover:bg-blue-200 transition"
//                 >
//                   ← Back to list
//                 </button>
//               </div>
...
//                 />
//                 <h4 className="font-bold text-blue-600">{vendor.name}</h4>
          ...
          {vendors.length === 0 ? (
            ...
            vendors.map((vendor) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500">{vendor.companyName}</p>
                <p className="text-sm text-gray-500 mt-1">{vendor.experience} yrs experience</p>
